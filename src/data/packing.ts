...
export const PACKING: PackingItem[] = [
  // === 공용 ===
  { id: 'p01', name: '훈제박스 (구매 필요)', type: '공용' },
  { id: 'p02', name: '폭죽/불꽃놀이', type: '공용' /* 멤버 임의로 구매 → 정산 */ },
  { id: 'p03', name: '돗자리/매트 (노상용)', type: '공용' },
  ...
  { id: 'p11', name: '숯/번개탄 (펜션 그릴 별도 필요시)', type: '공용' },
  ...
  { id: 'p21', name: '버릴 옷 위아래 (머드축제용)', type: '개인' },
  { id: 'p22', name: '버릴 옷 넣을 비닐', type: '개인' },
  {
    id: 'p23',
    name: '크록스 / 슬리퍼 / 조리 (머드축제용)',
    type: '개인',
    /* 운동화 X */
  },
