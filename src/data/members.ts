...
export const MEMBERS: Member[] = [
  { id: 'jihwan',  name: '지환',  emoji: '🌟', mbti: 'ENFP', confirmed: true /* 텐션 좋음 */ },
  { id: 'jibin',   name: '지빈',  emoji: '🪩', mbti: 'ESFP', confirmed: true /* 분위기메이커 */ },
...
// 차량 1대 렌트 (8인승급). 운전자 미정 — 정해지면 isDriver:true 추가.
